...
function pressKeyDown(e) {
    if (!gameOver) {
        if (e.keyCode == 87) {//code for up w
            ship.up = true
        }
        if (e.keyCode == 65) {//code for left a
            ship.left = true
        }
        if (e.keyCode == 68) {//code for right d
            ship.right = true
        }
        if (e.keyCode == 83) {//code for down s
            ship.down = true
        }
    }
